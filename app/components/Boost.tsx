export default function Boost() {
  return (
    <section
      className="relative inset-0 bg-purple-900 bg-no-repeat bg-center bg-cover py-8 px-6 md:px-12 lg:px-24"
      style={{
    ...
    >
      <div className="max-w-screen-xl mx-auto text-center ">
        ...
        <button className="btn font-bold py-3 px-6 rounded-full">
          Get Started
        </button>
      </div>
    </section>
